...
<form action="edit_comment.php?id=<?php echo htmlspecialchars($comment_id); ?>" method="post" enctype="multipart/form-data" class="comment-form" style="margin-top:40px;" onsubmit="return validateForm();">
    <div>
        ...
        <input type="text" name="content" id="content"  style="width:100%;padding:8px;font-size:16px;box-sizing:border-box;" value="<?php echo htmlspecialchars(isset($_POST['content']) ? $_POST['content'] : ($content ?? '')); ?>">
    </div>
    <div>
