...
<body>
    <!--header-top start -->
			        ...
			        <div class="container">
			            ...
			            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
			                <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                                ...
                                <li><a href="./article_management/show.php">Articles</a></li>								<li class="scroll"><a href="forum.php">forum</a></li>
		...
		<section id="home" class="welcome-hero">
			...
			<div class="container">
				<div class="welcome-hero-txt">
					<h2>Eco and Smart, A Hotel That Sets It Apart! </h2>
					<p>Discover Smart Services for Hotels from Eco Solutions to Premium Maintenance All in One Click!					</p>
				</div>
					...
					<div class="welcome-hero-form">
						<div class="single-welcome-hero-form">
							...
							<form action="home.php">
								<input type="text" placeholder="Ex: Vaccum ,Brushes ,Irons" />
							</form>
						</div>
						<div class="single-welcome-hero-form">
							<h3>Service</h3>
							<form action="home.php">
								<input type="text" placeholder="Ex: CLeaning ,Gardening ,Electricity" />
							</form>
						</div>
					</div>
		...
		<section id="list-topics" class="list-topics">
			<div class="container">
            <h1 class="section-heading text-center">Who We Work With</h1>
					...
					<div class="row">
						<div class="col-md-4 col-sm-6">
							<div class="single-how-works">
								...
								<h2><a href="#">Smart Equipements </a></h2>
								<p>Discover our range of smart and sustainable equipment, crafted to boost efficiency and simplify your daily operations with ease.</p>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-how-works">
								...
								<h2><a href="#">Get the Perfect Service</a></h2>
								<p>From regular maintenance to tailored solutions, we provide the right service at the right time—ensuring smooth, reliable operations for your team.								</p>
								<button class="welcome-hero-btn how-work-btn" onclick="window.location.href='#'">
								explore more
								</button>
							</div>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-how-works">
								...
								<h2><a href="#">Read More About Us Blog</a></h2>
								<p>Stay updated with industry trends, success stories, and tips from our experts on how to optimize hospitality services and smart operations.								</p>
								<button class="welcome-hero-btn how-work-btn" onclick="window.location.href='#'">
								explore more
								</button>
							</div>
