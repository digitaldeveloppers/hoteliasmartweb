...
function getVoteCount($post_id, $vote_type) {
    ...
    $stmt->execute([$post_id, $vote_type]);
...
<body>
        ...
        <header>
            ...
            <div class="header-buttons">
                ...
                <div class="notifications-wrapper" style="position: relative;">
                    <button id="notificationsBtn" class="btn">
            ...
            <?php if (count($result) > 0): ?>
                <?php foreach($result as $post): ?>
                    <article class="post-card" data-post-id="<?php echo $post['id']; ?>">
                        ...
                        <!-- Inside your post card HTML -->
                        <!-- Inside your post card loop, add the report button -->
                        <div class="post-meta">
                            ...
                            <!-- Add Report Button -->
                            <button class="report-btn" onclick="showReportModal(<?php echo $post['id']; ?>)">
                        ...
                        <div id="reportModal" class="modal">
                            <div class="modal-content">
                                ...
                                <div class="modal-buttons">
                                    <button onclick="reportPost(true)">Yes</button>
                                    <button onclick="reportPost(false)">No</button>
                                </div>
                            </div>
                        </div>
                        
                        <!-- Make sure this script is included before closing body tag -->
    ...
    <div id="chatContainer" class="chat-container">
        <div class="chat-header">
            <h3>Hotel Supplies Assistant</h3>
        ...
        <div class="chat-input-container">
            <textarea id="chatInput" class="chat-input" placeholder="Ask me anything..."></textarea>
